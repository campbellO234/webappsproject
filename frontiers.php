...
<head>
  ...
  <title>Sonic Frontiers - Blockbuster Online</title>
...
<body>
  ...
  <div class="container">
    <div class="product-image">
      <img src="images/frontiers.png" alt="Product Image" width="500" height="666">
    </div>
    <div class="product-details">
      <?php
      $sql_product = "SELECT * FROM games WHERE sid = 5";
    ...
    <div class="customer-reviews">
      ...
      <div class="review">
        <p>this game is beautiful and super fast</p>
        <p class="review-author">- brennen</p>
        <p class="review-rating">★★★★★</p>
      </div>
      <div class="review">
        <p>lots of pop-in but fun</p>
        <p class="review-author">- jacob</p>
        <p class="review-rating">★★★☆☆</p>
      </div>
    </div>
  </div>
  ...
  <div id="purchaseModal" class="modal">
    <div class="modal-content">
      ...
      <img src="images/frontiers.jpg" alt="Product Image" width="300" height="400">
