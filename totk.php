...
<head>
  ...
  <title>The Legend of Zelda: Tears of the Kingdom - Blockbuster Online</title>
...
<body>
  ...
  <div class="container">
    <div class="product-image">
      <img src="images/totk.jpg" alt="Product Image" width="400" height = "666">
    </div>
    <div class="product-details">
    <?php
      $sql_product = "SELECT * FROM games WHERE sid = 2";
    ...
    <div class="customer-reviews">
      ...
      <div class="review">
        <p>This game pretty baller</p>
        <p class="review-author">- jamal</p>
        <p class="review-rating">★★★★★</p>
      </div>
      <div class="review">
        <p>pretty alright</p>
        <p class="review-author">- isaiah</p>
        <p class="review-rating">★★★☆☆</p>
      </div>
    </div>
  </div>
  <div id="purchaseModal" class="modal">
    <div class="modal-content">
      ...
      <img src="images/totk.jpg" alt="Product Image" width="268" height="447">
