...
<head>
  ...
  <title>Minecraft - Blockbuster Online</title>
...
<body>
  ...
  <div class="container">
    <div class="product-image">
      <img src="images/minecraft.jpg" alt="Product Image" width="500" height = "666">
    </div>
    <div class="product-details">
      
    <?php
      $sql_product = "SELECT * FROM games WHERE sid = 8";
  ...
  <div id="purchaseModal" class="modal">
    <div class="modal-content">
      ...
      <img src="images/minecraft.jpg" alt="Product Image" width="300" height="400">
