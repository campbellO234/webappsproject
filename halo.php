...
<head>
  ...
  <title>Halo Infinite - Blockbuster Online</title>
...
<body>
  ...
  <div class="container">
    <div class="product-image">
      <img src="images/infinite.jpg" alt="Product Image" width="500" height = "666">
    </div>
    <div class="product-details">
    <?php
      $sql_product = "SELECT * FROM games WHERE sid = 6";
    ...
    <div class="customer-reviews">
      ...
      <div class="review">
        <p>i really like the multiplayer</p>
        <p class="review-author">- joe</p>
...
<div id="purchaseModal" class="modal">
    <div class="modal-content">
      ...
      <img src="images/infinite.jpg" alt="Product Image" width="300" height="400">
