...
<head>
  ...
  <title>God of War: Ragnarok - Blockbuster Online</title>
...
<body>
  ...
  <div class="container">
    <div class="product-image">
      <img src="images/ragnarok.png" alt="Product Image" width="500" height = "666">
    </div>
    <div class="product-details">

    <?php
      $sql_product = "SELECT * FROM games WHERE sid = 4";
    ...
    <div class="customer-reviews">
      ...
      <div class="review">
        <p>the story is super awesome</p>
  ...
  <div id="purchaseModal" class="modal">
    <div class="modal-content">
      ...
      <img src="images/ragnarok.jpg" alt="Product Image" width="300" height="400">
