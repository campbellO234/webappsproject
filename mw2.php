...
<head>
  ...
  <title>Call of Duty: Modern Warfare II - Blockbuster Online</title>
...
<body>
  ...
  <div class="container">
    <div class="product-image">
      <img src="images/mw2.jpg" alt="Product Image" width="500" height = "666">
    </div>
    <div class="product-details">
    <?php
      $sql_product = "SELECT * FROM games WHERE sid = 7";
    ...
    <div class="customer-reviews">
      ...
      <div class="review">
        <p>i love playing competitve online</p>
        <p class="review-author">- amari</p>
  ...
  <div id="purchaseModal" class="modal">
    <div class="modal-content">
      ...
      <img src="images/mw2.jpg" alt="Product Image" width="300" height="400">
