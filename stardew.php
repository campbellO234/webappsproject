...
<head>
  ...
  <title>Stardew Valley - Blockbuster Online</title>
...
<body>
  ...
  <div class="container">
    <div class="product-image">
      <img src="images/stardew.jpg" alt="Product Image" width="500" height = "666">
    </div>
    <div class="product-details">

    <?php
      $sql_product = "SELECT * FROM games WHERE sid = 3";
    ...
    <div class="customer-reviews">
      ...
      <div class="review">
        ...
        <p class="review-author">- molli</p>
        <p class="review-rating">★★★★★</p>
      </div>
      <div class="review">
        <p>nice, relaxing aura</p>
        <p class="review-author">- owen</p>
        <p class="review-rating">★★★☆☆</p>
      </div>
    </div>
  </div>
  <div id="purchaseModal" class="modal">
    <div class="modal-content">
      ...
      <img src="images/stardew.jpg" alt="Product Image" width="300" height="400">
